...
(defn -main [& args]
  (let [[pop-size max-gen tournament-size test-number] (map read-string args)
        test-data (case test-number 0 program-0 1 program-1 2 program-2)]
    (evolve pop-size max-gen tournament-size test-data)))
